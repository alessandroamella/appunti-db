...
% --- Immagini ---
\usepackage{float}
% \usepackage{tikz} % Non utilizzato in questo documento
% \usetikzlibrary{shapes.geometric, positioning, calc} % Non utilizzato
...
\hypersetup{
	...
	filecolor=magenta,
	urlcolor=cyan,       % Cambiato da blue a cyan per migliore visibilità su nero
	pdftitle={Appunti Corso di Database: Introduzione},
...
\setminted{
	...
	style=monokai    % Stile di highlighting (buono per sfondo scuro)
}
\usemintedstyle{monokai} % Assicura che lo stile sia applicato
