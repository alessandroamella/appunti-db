...
\usepackage{array} % Per definire la larghezza delle colonne

% --- Hyperlink ---
\usepackage{hyperref}
\hypersetup{
	colorlinks=true,
	linkcolor=white, % Link interni più visibili su sfondo nero
	filecolor=magenta,
	urlcolor=cyan,   % URL più visibili
	pdftitle={Appunti sulla Progettazione Concettuale di Basi di Dati},
	pdfpagemode=FullScreen,
	citecolor=green % Se usi citazioni
}
...
\usemintedstyle{monokai} % Assicura che lo stile sia applicato globalmente

% --- Comandi personalizzati (se necessari per questo contesto, altrimenti rimuovere) ---
